...
import { injectStyle } from '../lib/inject-style.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { PREPARATION_CSS } from '../style/preparation.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
// preparation.js — Screen 2: Preparation Phase (3-min timer, 5-slot field, ZK commit)
// mount(container, detail) / unmount(container)

import { practiceOpponent } from '../lib/practice-mode.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { summarizeHand } from '../lib/hand-summary.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { ALL_CARD_IDS, getCard } from '../lib/cards.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { CardFrameHTML, injectCardCSS, ACTION_LABELS, CARD_NAMES, FACTION_NAMES } from './common/Card.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { ActionTypeSelectorHTML, injectActionTypeSelectorCSS, ACTION_TYPES } from './common/ActionTypeSelector.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { placeInHand, completeHand, snapshotHand } from '../lib/preparation-hand.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { startTimer } from './common/Timer.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { RoundHudHTML, injectRoundUiCSS } from './common/round-ui.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { EnergyHudHTML, attachEnergyHud, injectEnergyCss, computeEnergy } from './common/energy-hud.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { pxIcon } from '../lib/px-icons.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { getState, setState } from '../state/battle-state.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import * as duelWs from '../lib/duel-ws.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
