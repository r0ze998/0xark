import { isPractice, createPracticeAdapters } from './lib/practice-mode.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
import { RELAY_URL } from './config.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e';
...
async function start() {
  ...
  if (isPractice) {
    ...
    await import('./onchain/index.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
    await classic('src/lib/x402-memo.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
    await classic('src/02-x402.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
    await classic('https://cdn.jsdelivr.net/npm/snarkjs@0.7.4/build/snarkjs.min.js');
    await import('./lib/wallet-adapter.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
    await classic('src/03-zk-prove.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
  }
  await import('../app.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e');
