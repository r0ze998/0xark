...
export function createPracticeApp({ router, getState, setState, search }) {
  ...
  function start() {
    ...
    if (view === 'menu') navigate('menu');
      ...
      import('../components/card-detail.js?v=77ad227ec8af177423afb2231a00ef4e30b5a65e').then(({ CardDetailModal }) => {
