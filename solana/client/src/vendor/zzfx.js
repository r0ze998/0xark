...
/* -- 0xARK ESM shim - appended, not upstream (upstream = first 1222 bytes, MIT, see ZZFX-LICENSE) -- */
const zzfxContext = () => zzfxX;
const setMasterVolume = (v) => { zzfxV = v; };
export { zzfx, zzfxContext, setMasterVolume };
