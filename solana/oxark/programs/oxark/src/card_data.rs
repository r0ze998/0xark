...
const fn card(
    id: u8, faction: u8, rarity: u8, bp: u8, hp: u8, ini: u8,
    action_type: u8, is_legendary: bool, passive: Option<PassiveAbility>,
) -> CardData {
    CardData { id, faction, rarity, bp, hp, ini, action_type, is_legendary, passive }
}
...
pub static CARDS: [Option<CardData>; 61] = [
    ...
    Some(card( 9, 0, 2,  8, 12, 3, 5, false, Some(PassiveAbility::KnightAura))),       // Vanguard
    ...
    Some(card(19, 1, 2,  8,  8, 3, 5, false, Some(PassiveAbility::MerchantGoldAura))), // Monopolist
    ...
    Some(card(29, 2, 2, 12,  5, 5, 2, false, Some(PassiveAbility::PirateIntimidate))), // Dreadnaught
    ...
    Some(card(39, 3, 2,  5,  8, 5, 5, false, Some(PassiveAbility::ScholarImprintScale))), // Seer
    ...
    Some(card(49, 4, 2,  8, 12, 1, 5, false, Some(PassiveAbility::MonkSoulHarvest))),  // Elder
    ...
    Some(card(59, 5, 2, 12,  8, 3, 0, false, Some(PassiveAbility::EngineerOverclock))), // Colossus
