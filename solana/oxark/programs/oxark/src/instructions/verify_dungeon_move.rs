...
/// VK β point (G2, 128 bytes: EIP-197 big-endian x1||x0||y1||y0)
...
/// VK γ point (G2, 128 bytes: EIP-197 big-endian x1||x0||y1||y0)
...
/// VK δ point (G2, 128 bytes: EIP-197 big-endian x1||x0||y1||y0)
